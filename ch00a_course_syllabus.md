...
> 2. 同學需針對所分配之每一題，進行完整的問題分析與實作說明，將成果彙整成一份期末專題書面報告。
> 3. 期末將於課堂中進行期末專題口頭報告。每位同學報告時間為五到十分鐘，可自行選擇一至兩題被分配的 LeetCode 題目進行報告。
> 4. 所有程式實作須以 Python 撰寫，並須確保程式碼之正確性、可讀性與整體結構之完整性。
...
# 授課大綱
[115上學期](https://timetable.nycu.edu.tw/?r=main/crsoutline&Acy=115&Sem=1&CrsNo=520030&lang=zh-tw)